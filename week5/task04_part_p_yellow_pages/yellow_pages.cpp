...
//    }
    ...
    CompanyName::CompanyName(const Json::Dict &company_name_json) {
        ...
        if (!company_name_json.count("type") || company_name_json.at("type").AsString() == "MAIN") {
    ...
    CompanyPhone::CompanyPhone(const Json::Dict &company_phone_json) {
        if (company_phone_json.count("formatted")) {
        ...
        if (company_phone_json.count("country_code")) {
            country_code_ = company_phone_json.at("country_code").AsString();
        }
        if (company_phone_json.count("local_code")) {
            local_code_ = company_phone_json.at("local_code").AsString();
        }
        if (company_phone_json.count("number")) {
        ...
        if (company_phone_json.count("description")) {
